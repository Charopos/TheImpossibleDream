          ...
          >
            ...
            <ul style={{ margin: '0 0 6px 16px', padding: 0 }}>
              <li style={{ marginBottom: 4 }}>
                {
                  'To prohibit the sale or trafficking of any physick or smoke stronger than purified moondust and ozium, lest the mind of any guest be so clouded as to forget the teachings of the Pantheon. Violation shall be fined a zilaque.'
                }
              </li>
              <li style={{ marginBottom: 4 }}>
                {
                  'To give no shelter to thieves nor fugitives, neither within the stews nor beneath them. Violation shall be fined a zenny, and the ill-gotten goods rendered unto the Temple for remedy.'
                }
              </li>
              <li style={{ marginBottom: 4 }}>
                {
                  "To suffer within the Baths no manifest scandal of false devotion. Of any attendant or guest who hath lost themselves to wanton hedonism or to the depravities of false rites, the Bathmaster shall inform the Temple in manner most discreet, and deliver such soul unto the Temple's care - that they may be shown again the light of Eora's love. So long as none is harmed, what is done behind closed doors the Ordinance shall not intrude upon; for Eora hath granted unto her faithful the gift of love and intimacy in privacy, as is pleasing to her sight."
                }
              </li>
              <li style={{ marginBottom: 4 }}>
                {
                  'To turn no soul away for want of coin who beareth the wounds of soldiery or the marks of pilgrimage, but to grant unto them the public bath without charge, once in the week. Failing this charity, the Bathmaster shall be fined a zenny, rendered unto the alms of the Temple.'
                }
              </li>
              <li style={{ marginBottom: 4 }}>
                {
                  "To render unto no drunken soul more liquor than they can hold; to serve no guest more than five sniffings of unguents in a single sitting; and to suffer no soul to take more of any physick than the body may bear, lest they fall into convulsion, delirium, or Necra's embrace before their time is due. The Bathmaster shall be answerable for any guest who is borne forth in such a state, and shall render unto the kin of the lost, or the Temple which must undertake their resuscitation, a recompense as the Temple shall judge fit."
                }
              </li>
            </ul>
            <p style={{ margin: '0 0 6px 0' }}>
              {
                "Should the ordinances be broken, the Temple may renounce its sanction or seek recompense as it see fit; the brassface shall fall again beneath the Crown's tariff, and the matter of the Baths' regular income shall be settled thereafter between the Bathmaster and the Crown alone."
              }
            </p>
