...
/obj/item/reagent_containers/food/snacks/grown/coffeebeansroasted
	...
	desc = "Roasted coffee beans, with a much deeper flavor. Can be used to brew coffee. The variant grown in Pharovia, uniquely, can be brewed without being ground. This is presumed to be a blessing of the Scar."
	icon = 'modular/Neu_Food/icons/drinks.dmi'
