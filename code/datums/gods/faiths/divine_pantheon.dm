/datum/faith/divine
	...
	desc = "The TEN, holy and eternal. The most accepted religion in the Midderland. The TEN became active in the lives of mortals after Psydon sent the Comet Syon to defeat the rampaging Archdevil and vanished from the world. \n \n\
	...
	worshippers = "Commonfolk, the Faithful, the Anointed, and the Denizens of the Midderland"
