...
/datum/economic_region/daftsmarch
	...
	description = "The County of Daftsmarch is the heart of the Kingdom's mining industry, a long strip of land hugging the southern end of Mount Decapitation. It produces most of the raw ore and salt that the Kingdom depends on. The work pays well, and the veins are plentiful. But Daftsmarch sits uncomfortably close to the ruins of Tarichea, and the various denizens of the Underdark. The dangers posed by the drows and their ilk are a constant threat - many of them seeing Daftsmarch as a convenient source of slaves. But the ore vein are even richer - and the Crown is loathe to keep them unused - sending adventurers, mercenaries and garrison alike to do battle with the Underdark's denizens and keep them at bay."
...
/datum/economic_region/northfort
	...
	description = "A fortified castle at the northern approach into the Kingdom, the only direct overland route from the north. As economically unproductive as a fort can be, which is very. The crown feeds it because without it, the border between Grenzelhoft and the Kingdom becomes negotiable."
...
/datum/economic_region/heartfelt
	...
	name = "Heartfelt"
	subtitle = "The Bloody Barony of the Border"
	description = "The County of Heartfelt is the Pharos' closest court, comprising nearly the entirety of the western borderland, bordering Otava, Grenzelhoft, Naledi, and Aavnr. The Count of Heartfelt has always been afforded considerable liberty in how they raise revenues and how many men they keep under arms, for if Heartfelt falls, His Majesty's heartland would be exposed. Its defense is funded by a network of estates, holdings, and acres scattered across hundreds of pockets in the Kingdom outside Heartfelt proper, which the Baron uses to purchase armaments and pay retinue alike. But any ruler within Pharos knows there is no greater threat to themselves than the self-professed greatest defender of the Kingdom."
	threat_region_id = THREAT_REGION_AZURE_GROVE
	produces = list()
	demands = list(
		TRADE_GOOD_STEEL_INGOT = TG_DEMAND_REFINED_INGOTS,
...
/datum/economic_region/hagenwald
	...
	description = "The industrial heart of the Kingdom, sitting on the northern face of Mount Decapitation, where Daftsmarch's ore is taken by mules to be smelted, refined, and forged. Hagenwald produces nearly every ingot of iron, steel, copper, and tin the kingdom uses - without its furnaces, the Kingdom's smiths would be reduced to working scrap. The town's wealth is built on coppiced woodland that flanks it on three sides, cut and re-cut on a generational rotation so the fire never go out. Its workforce is half Grenzelhoftian by descent, drawn over the centuries by wages, and the streets are perpetually grey with soot. The Crown garrisons it quietly."
	threat_region_id = THREAT_REGION_MOUNT_DECAP
	produces = list(
