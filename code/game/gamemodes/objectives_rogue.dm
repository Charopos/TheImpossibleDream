...
/datum/objective/vampire
	name = "conquer"
	explanation_text = "Put an end to the werewolf menace across Pharos, or unite with them against the forces of the cattle."
	team_explanation_text = "The feud between werewolves and vampires reaches back to the dawn of time. Will the two factions destroy each other, or find a way to coexist and face the mortals of the Scar together?"
	triumph_count = 5
