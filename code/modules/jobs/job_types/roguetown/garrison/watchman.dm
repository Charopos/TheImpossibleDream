/datum/job/roguetown/watchman //This exists PURELY so the convert verb has something TO convert to
	...
	tutorial = "You are the club in the dark for the Crown, patrolling the streets of Pharos dae and nite on the lookout for knaves and vagabonds looking to cause trouble. \
