...
/datum/job/roguetown/heartfelt/knight
	...
	Now, alone and committed to safeguarding the court, you ride to the Scar, resolved to ensure their safe arrival."
...
/datum/advclass/heartfelt/knight
	...
	Now, alone and committed to safeguarding what remains of your court, you ride to the Scar, resolved to ensure their safe arrival."
	allowed_sexes = list(MALE, FEMALE)
	forbidden_races = list(RACES_CONSTRUCT RACES_DESPISED)
