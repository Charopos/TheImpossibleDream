...
/datum/job/roguetown/guildsman
	...
	tutorial = "You are a member of the Pharovian Guild of Crafts, a massive guild formed to represent the interests of all craftsmen in the township of Pharos.\
