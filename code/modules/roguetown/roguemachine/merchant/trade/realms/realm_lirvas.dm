/datum/foreign_realm/lirvas
	...
	hail_lines = list(
		...
		"Rumors says that Lord Zarvlor does not eat proper food and only eat gold. Do not let that deters you, the people of the Inner Ring are quite fond of Pharovian seafood. Send me anything and everything you have that is quality and worth the space of runic chests home."
	)
